Xin chào, đây là một dự án E-Commerce được xây dựng bằng React (TypeScript), Node.js và MongoDB.

Trong quá trình phát triển, tôi đã nhiều lần refactor và tối ưu lại hệ thống thay vì chỉ hoàn thành chức năng cơ bản. Mỗi lần refactor là một quá trình nâng cấp tư duy và kiến thức thực tế về frontend architecture, state management, API handling và performance optimization.
